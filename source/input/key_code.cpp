...
namespace citadel {
	const std::unordered_map<key_code, std::string> key_names = {
		...
		{ key_code::colon,                ":" },
		{ key_code::semicolon,            ";" },
		{ key_code::open_angle_bracket,   "<" },
		{ key_code::equal,                "=" },
		{ key_code::close_angle_bracket,  ">" },
		...
		{ key_code::Y,                    "Y" },
		{ key_code::Z,                    "Z" },
		{ key_code::open_square_bracket,  "[" },
		{ key_code::backslash,            "\\" },
		{ key_code::close_square_bracket, "]" },
		{ key_code::caret,                "^" },
		...
		{ key_code::y,                    "y" },
		{ key_code::z,                    "z" },
		{ key_code::open_curly_bracket,   "{" },
		{ key_code::pipe,                 "|" },
		{ key_code::close_curly_bracket,  "}" },
		{ key_code::tilde,                "~" },
		{ key_code::del,                  "Del" },

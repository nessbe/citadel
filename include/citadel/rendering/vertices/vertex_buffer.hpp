...
namespace citadel {
	...
	public:
		nodisc static std::shared_ptr<vertex_buffer> create(rendering_api_type api, std::size_t size, const vertex_buffer_layout& layout);
		nodisc static std::shared_ptr<vertex_buffer> create(rendering_api_type api, const void* data, std::size_t size, const vertex_buffer_layout& layout);

		nodisc static std::shared_ptr<vertex_buffer> create(std::size_t size, const vertex_buffer_layout& layout);
		nodisc static std::shared_ptr<vertex_buffer> create(const void* data, std::size_t size, const vertex_buffer_layout& layout);

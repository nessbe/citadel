...
#define CITADEL_VECTOR_ITERATOR_WRAPPER(type, property)                                                    \
	...
	::std::vector<type>::const_reverse_iterator crbegin() const noexcept { return property.rbegin(); } \
	::std::vector<type>::const_reverse_iterator crend() const noexcept { return property.rend(); }

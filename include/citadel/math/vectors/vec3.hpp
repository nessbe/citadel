...
namespace citadel {
	...
	public:
		...
		nodisc basic_vec3<T> normalized() const;

		nodisc T distance(const basic_vec3<T>& other) const;

		nodisc T dot(const basic_vec3<T>& other) const;
		nodisc basic_vec3<T> cross(const basic_vec3<T>& other) const;
		...
		nodisc basic_vec3<T> operator+(const basic_vec3<T>& other) const;
		nodisc basic_vec3<T>& operator+=(const basic_vec3<T>& other);
		...
		nodisc basic_vec3<T> operator*(T scalar) const;
		nodisc basic_vec3<T>& operator*=(T scalar);
